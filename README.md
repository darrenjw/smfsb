...
This page contains links, code snippets, software and other information relating to the third edition of the book, Stochastic Modelling for Systems Biology, to be published by Chapman & Hall/CRC, end of November 2018 (in time for Christmas!).
